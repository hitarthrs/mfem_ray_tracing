...
#include "tspline_corner_collar.hpp"
...
/// Assemble interiors plus all local baked seam strips.  The returned report is
/// deliberately diagnostic even when unresolved multi-interface corner claims
/// make the shell unsafe for RT; call RequireShellReadyForRayTracing before
/// RegisterPatches or JSON emission in strict workflows.
